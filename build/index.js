...
var DrapcodeApis = /** @class */ (function () {
  ...
  DrapcodeApis.prototype.getBaseUrl = function () {
    ...
    switch (this.environment) {
      case "PRODUCTION":
        ...
        break;
      case "PREVIEW":
        envDomain = "api.preview.";
        break;
      case "BETA":
        envDomain = ".api.sandbox.";
        break;
      case "ALPHA":
        envDomain = ".api.uat.";
        break;
    ...
    return "https://"
      .concat(this.project_seo_name, envDomain)
      .concat(this.API_PATH);
  };
  ...
  DrapcodeApis.prototype.getItemsWithFilter = function (
    collectionName,
    filterUuid
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          (0, methods_1.getItemsWithFilter)(
            this.getBaseUrl(),
            this.getHeaders(),
            collectionName,
            filterUuid
  ...
  DrapcodeApis.prototype.getItemsCountWithFilter = function (
    collectionName,
    filterUuid
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          (0, methods_1.getItemsCountWithFilter)(
            this.getBaseUrl(),
            this.getHeaders(),
            collectionName,
            filterUuid
  ...
  DrapcodeApis.prototype.updateItemWithUuid = function (
    collectionName,
    itemUuid,
    body
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          (0, methods_1.updateItemWithUuid)(
            this.getBaseUrl(),
            this.getHeaders(),
            collectionName,
            itemUuid,
  ...
  DrapcodeApis.prototype.deleteItemWithUuid = function (
    collectionName,
    itemUuid
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          (0, methods_1.deleteItemWithUuid)(
            this.getBaseUrl(),
            this.getHeaders(),
            collectionName,
            itemUuid
