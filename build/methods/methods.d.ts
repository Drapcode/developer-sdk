 ...
 * POST Calls
 */
export declare const createItem: (baseurl: string, headers: Record<string, string>, version: number, collectionName: string, body: any) => Promise<unknown>;
...
export declare const getItemWithUuid: (baseurl: string, headers: Record<string, string>, version: number, collectionName: string, itemId: string) => Promise<unknown>;
...
export declare const getItemsWithFilter: (baseurl: string, headers: Record<string, string>, version: number, collectionName: string, filterUuid: string) => Promise<unknown>;
export declare const getItemsCountWithFilter: (baseurl: string, headers: Record<string, string>, version: number, collectionName: string, filterUuid: string) => Promise<unknown>;
